...
*/
const displayNames = [];
zooAnimals.forEach(animal => displayNames.push({ animal_name: animal["animal_name"], scientific_name: animal["scientific_name"] }))
...
const lowCaseAnimalNames = displayNames.map(animal => animal["animal_name"].toLowerCase());
